        ...
        <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8 fade-in">
                    ...
                    <h1 className="text-2xl font-bold gradient-text mb-2 sm:text-3xl">
                        IBA Sukkur Portal
                    </h1>
              ...
              >
                ...
                {/* Footer */}
                <p className="text-center text-gray-500 text-sm mt-6 fade-in">
                    IBA Sukkur University &copy; 2024
                </p>
            </div>
        </div>
    );
